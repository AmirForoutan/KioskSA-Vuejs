...
const permsCatalog = [
  ...
  { key: "view.inventory", title: "مشاهده کلی انبار" },
  { key: "manage.inventory", title: "مدیریت کامل انبار" },
  { key: "view.inventory.settings", title: "انبار - مشاهده تنظیمات و کالاها" },
  { key: "manage.inventory.settings", title: "انبار - مدیریت تنظیمات و کالاها" },
  { key: "view.inventory.documents", title: "انبار - مشاهده اسناد انبار" },
  { key: "manage.inventory.documents", title: "انبار - ثبت و مدیریت اسناد انبار" },
  { key: "view.inventory.reports", title: "انبار - مشاهده گزارش موجودی" },
  { key: "view.inventory.kardex", title: "انبار - مشاهده کاردکس کالا" },
  { key: "view.inventory.stocktaking", title: "انبار - مشاهده انبارگردانی" },
  { key: "manage.inventory.stocktaking", title: "انبار - ثبت انبارگردانی" },
  { key: "view.inventory.suppliers", title: "انبار - مشاهده تأمین‌کننده‌ها" },
  { key: "manage.inventory.suppliers", title: "انبار - مدیریت تأمین‌کننده‌ها" },
  { key: "view.inventory.history", title: "انبار - مشاهده سابقه تغییرات" },
  { key: "view.inventoryAnalysis", title: "مشاهده آنالیز کالا" },
  { key: "manage.inventoryAnalysis", title: "مدیریت آنالیز کالا" },
