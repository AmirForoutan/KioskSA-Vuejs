...
(__VLS_ctx.category.GroupId ? 'ویرایش دسته‌بندی' : 'افزودن دسته‌بندی جدید');
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
    ...
    value: (__VLS_ctx.localCategory.GroupCode),
    type: "text",
    ref: "groupcode",
});
/** @type {typeof __VLS_ctx.groupcode} */ ;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "form-group" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
    ...
    value: (__VLS_ctx.localCategory.GroupName),
    type: "text",
    ref: "groupname",
});
/** @type {typeof __VLS_ctx.groupname} */ ;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "form-group" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({});
...
(__VLS_ctx.localCategory.IsActive);
