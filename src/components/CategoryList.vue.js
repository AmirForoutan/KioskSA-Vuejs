...
if (!__VLS_ctx.selectedGroup) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
    if (__VLS_ctx.isScaleOrder || __VLS_ctx.selectedGroup) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (__VLS_ctx.confirmBack) },
            ...{ class: "back-button2" },
        });
    }
    if (__VLS_ctx.hasItemsInCart != 0) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...
    if (__VLS_ctx.loading) {
        ...
        for (const [group] of __VLS_getVForSourceType((__VLS_ctx.groups))) {
            ...
            __VLS_asFunctionalElement(__VLS_intrinsicElements.img)({
                ...
                ...{ class: "w-full groupimage h-32 object-contain mb-2" },
                alt: (group.GroupTitle),
            });
            __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                ...{ class: "text-lg div_font" },
            });
            (group.GroupName);
        }
    }
    ...
    /** @type {[typeof GoodsList, ]} */ ;
    // @ts-ignore
    const __VLS_0 = __VLS_asFunctionalComponent(GoodsList, new GoodsList({
        ...{ 'onGoBack': {} },
...
/** @type {__VLS_StyleScopedClasses['groups-grid']} */ ;
/** @type {__VLS_StyleScopedClasses['groups-item']} */ ;
/** @type {__VLS_StyleScopedClasses['w-full']} */ ;
/** @type {__VLS_StyleScopedClasses['groupimage']} */ ;
/** @type {__VLS_StyleScopedClasses['h-32']} */ ;
/** @type {__VLS_StyleScopedClasses['object-contain']} */ ;
/** @type {__VLS_StyleScopedClasses['mb-2']} */ ;
/** @type {__VLS_StyleScopedClasses['text-lg']} */ ;
/** @type {__VLS_StyleScopedClasses['div_font']} */ ;
var __VLS_dollars;
